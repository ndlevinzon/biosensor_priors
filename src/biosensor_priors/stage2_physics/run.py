"""Stage 2 orchestration: ligands → RF3 docking scan → uncertainty → Gate 2."""
...
def run_stage2(
    *,
    ...
    External RF3 / QM tools are optional. With ``backend: mock`` the Python
    ...
    manifest = write_manifest(
        ...
        parameters={
            ...
            "delta_rif_sel_definition": "rif_ac - rif_prop (negated RF3 docking confidence)",
        },
        outputs={
